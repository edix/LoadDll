...
static void
ExecuteTLS(PMEMORYMODULE module, BOOL fDebugBreak) 
{
    unsigned char *codeBase = module->codeBase;
...
HMEMORYMODULE MemoryLoadLibrary(const void *data, BOOL fDebugBreak)
{
    return MemoryLoadLibraryEx(data, _LoadLibrary, _GetProcAddress, _FreeLibrary, NULL, fDebugBreak);
}
...
HMEMORYMODULE MemoryLoadLibraryEx(const void *data,
    ...
    CustomGetProcAddressFunc getProcAddress,
    CustomFreeLibraryFunc freeLibrary,
    void *userdata, BOOL fDebugBreak)
{
